...
/***/ (function(module, exports, __webpack_require__) {
	...
	var StickerWall = function StickerWall() {
		...
		var addSticker = function addSticker() {
			...
			var newSticker = stickersTmpl({ stickers: [sticker] });
		...
		var exportJson = function exportJson() {
			if (confirm("Continue to download sticker list json file?")) {
				var stickerListString = localStorage.getItem("stickers");
				var fileName = "stickers.json";
				var blob = new Blob([stickerListString], { type: "text/json;charset=utf-8" });
		...
		(0, _jquery2.default)('body').on('click', '#export_json', exportJson);
